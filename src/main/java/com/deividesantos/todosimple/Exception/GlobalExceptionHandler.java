package com.deividesantos.todosimple.Exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    public ResponseEntity<Object> handleAllUncaughtException(
        ...
        final String erroMessage="Unknown error ocurred";
        log.error(erroMessage,exception);
    ...
    public ResponseEntity<Object>handleDataIntegityViolationException(
            DataIntegrityViolationException dataIntegrityViolationException,
            WebRequest request
    ){
        String errorMessage = dataIntegrityViolationException.getMostSpecificCause().getMessage();
        log.error("Failed to save entity with integity problems:"+ errorMessage,dataIntegrityViolationException);
        return buildErrorResponse(
...
public ResponseEntity<Object> handleConstraintViolationException(
        ...
        log.error("Faild to validate element", constraintViolationException);
        return buildErrorResponse(
...
public ResponseEntity<Object> handleDataBindingViolationException(
        ...
        log.error("Failed to save",dataBindingViolationException);
        return buildErrorResponse(
...
public ResponseEntity<Object> handleAcessDeniedException(
...
@ResponseStatus(HttpStatus.FORBIDDEN)
public ResponseEntity<Object> handleAuthorizationEception(
